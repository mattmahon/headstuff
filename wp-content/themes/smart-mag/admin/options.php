					...
					array(
						...
						'css'   => array(
							'selectors' => 'body, .main .sidebar .widgettitle, .tabbed .tabs-list, h3.gallery-title, .comment-respond small, .main-heading, ' 
											. '.gallery-title, .section-head, .main-footer .widgettitle, .entry-title'
						),
						'families' => true,
						'suggested' => array(
							'Open Sans' => 'Open Sans',
					...
					array(
						...
						'css' => array(
							'selectors' => array(
									...
									.modal-header .modal-title, .entry-title' 
										=> 'border-left-color: %s',
			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'desc'  => __('This is the background color used when you hover a menu item.  It is not used for active state.', 'bunyad'),
						'type' => 'color',
						'css' => array(
							'selectors' => array(
